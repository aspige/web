...
class PHPMailer
{
    ...
    public function setLanguage($langcode = 'es', $lang_path = '')
    {
        ...
        $PHPMAILER_LANG = array(
            ...
            'connect_host' => 'Error SMTP: No se pudo conectar al servidor SMTP.',
            'data_not_accepted' => 'Error SMTP: Los datos no fueron aceptados.',
            'empty_message' => 'El cuerpo del mensaje está vacío.',
            'encoding' => 'Codificación desconocida: ',
            'execute' => 'No se pudo ejecutar: ',
            'file_access' => 'No se pudo acceder al archivo: ',
            'file_open' => 'Error de archivo: No se pudo abrir el archivo: ',
            'from_failed' => 'La dirección de remitente falló: ',
            'instantiate' => 'No se pudo iniciar la función de correo.',
            'invalid_address' => 'Dirección inválida',
            'mailer_not_supported' => 'El método de envío no está soportado.',
            'provide_address' => 'Debe proporcionar al menos una dirección de correo electrónico de destinatario.',
            'recipients_failed' => 'Error SMTP: Los siguientes destinatarios fallaron: ',
            'signing' => 'Error de firma: ',
            'smtp_connect_failed' => 'La conexión SMTP falló.',
            'smtp_error' => 'Error del servidor SMTP: ',
            'variable_set' => 'No se puede establecer o reiniciar la variable: '
        );
        if (empty($lang_path)) {
