...
! function(e, t) {
  ...
  function b(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === he.type(o)) he.merge(p, o.nodeType ? [o] : o);
    else
    if (Ge.test(o)) {
    ...
    if (l = he.contains(o.ownerDocument, o), a = y(f.appendChild(o), "script"), l && x(a), n) for (c = 0; o = a[c++];) Ue.test(o.type || "") && n.push(o);
    return f
  }
  function w() {
    return !0
  ...
  he.extend = he.fn.extend = function() {
    ...
    s++), "object" == typeof a || he.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++) if (null != (e = arguments[s])) for (t in  e) n = a[t],
    r = e[t],
    a !== r && (l && r && (he.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && he.isPlainObject(n) ? n : {},
  ...
  var xe = function(e) {
    function t(e, t, n, r) {
      ...
      if (!r && ((t ? t.ownerDocument || t : I) !== q && A(t), t = t || q, H)) {
        if (11 !== h && (u = ge.exec(e))) if (i = u[1]) {
          ...
          if (d && (a = d.getElementById(i)) && R(t, a) && a.id === i) return n.push(a),
          n
        } else {
    ...
    function p(e, t, n) {
      ...
      return t.first ? function(t, n, i) {
        ...
        for (; t = t[r];) if (1 === t.nodeType || a) if (f = t[M] || (t[M] = {}), c = f[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
        else {
    ...
    function m(e) {
      ...
      a, !0), c = [function(e, n, r) {
        ...
        return t = null,
        i
      }]; s < i; s++) if (n = w.relative[e[s].type]) c = [p(d(c), n)];
      else {
        ...
        CHILD: function(e, t, n, r, i) {
          ...
          return 1 === r && 0 === i ? function(e) {
            ...
            if (v) {
              ...
              if (y && (p = t, f = p[M] || (p[M] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === W && l[1], x = d), !1 === x) for (;
    ...
    c = {
      ...
      remove: function() {
        return he.each(arguments, function(e, t) {
          for (var n;
          (n = he.inArray(t, o, n)) > -1;) o.splice(n, 1),
          n <= u && u--
        }),
        this
      },
            ...
            return function() {
              ...
              f = function() {
                ...
                if (! (t < a)) {
                  ...
                  he.isFunction(f) ? i ? f.call(e, o(a, n, u, i), o(a, n, l, i)) : (a++, f.call(e, o(a, n, u, i), o(a, n, l, i), o(a, n, u, n.notifyWith))) : (r !== u && (s = void 0, c = [e]), (i || n.resolveWith)(s, c))
                }
              },
              p = i ? f : function() {
                try {
                  ...
                  t + 1 >= a && (r !== l && (s = void 0, c = [e]), n.rejectWith(s, c))
                }
              };
  ...
  var Le = function(e, t, n, r, i, o, a) {
    ...
    if (void 0 !== r && (i = !0, he.isFunction(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function(e, t, n) {
  ...
  p.prototype = {
    ...
    remove: function(e, t) {
      ...
      if (void 0 !== r) {
        if (void 0 !== t) {
          Array.isArray(t) ? t = t.map(he.camelCase) : (t = he.camelCase(t), t = t in  r ? [t] : t.match(je) || []),
          n = t.length;
          for (; n--;) delete r[t[n]]
  ...
  he.fn.extend({
    ...
    stop: function(e, t, n) {
      ...
      this.each(function() {
        ...
        for (i = o.length; i--;) o[i].elem !== this || null != e && o[i].queue !== e || (o[i].anim.stop(n), t = !1, o.splice(i, 1)); ! t && n || he.dequeue(this, e)
      })
    },
    finish: function(e) {
      return !1 !== e && (e = e || "fx"),
  ...
  he.extend(he.event, {
    trigger: function(t, n, r, i) {
      ...
      i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
        ...
        for (o = 0;
        (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d,
  ...
  he.extend({
    ...
    ajax: function(t, n) {
      ...
      n = n || {};
      var i, o, a, s, u, l, c, f, p, d, h = he.ajaxSetup({},
      n),
      g = h.context || h,
...
(function($, h, c) {
  var a = $([]),
  e = $.resize = $.extend($.resize, {}), i, k = "setTimeout", j = "resize", d = j + "-special-event", b = "delay", f = "throttleWindow"; e[b] = 250; e[f] = true;
  $.event.special[j] = {
    setup: function() {
      if (!e[f] && this[k]) {
        return false
...
! function(e) {
  ...
  function t(n, t) {
    ...
    function xe(e, n) {
      ...
      return l < 0 && (l = 480 - Math.abs(l)),
      l
    }
    function Se(e, n) {
      if (Pe(e, n)) return c;
      var t = xe(e, n);
      return t <= 45 && t >= 0 ? r : t <= 480 && t >= 315 ? r : t >= 135 && t <= 225 ? i : t > 45 && t < 135 ? o : l
    }
    function Oe() {
  ...
  e.fn.swipe = function(t) {
    ...
    if (i && "object" == typeof t) i.option.apply(i, arguments);
    else
    if (! (i || "object" != typeof t && t)) return n.apply(this, arguments);
    return r
  },
    ...
    modifiers: {
      ...
      arrow: {
        ...
        fn: function(e, t) {
          ...
          if (!e.instance.popper.contains(o)) return console.warn('WARNING: `arrow.element` must be child of its popper element!'),
          e;
...
default:
  ...
  h = function() {
    ...
    f = function() {
      ...
      f.nextWhenVisible = function() { ! document.hidden && e(this._element).is(":visible") && "hidden" !== e(this._element).css("visibility") && this.next()
      },
      f.prev = function() {
      ...
      f._slide = function(t, n) {
        ...
        if (!this._triggerSlideEvent(_, o).isDefaultPrevented() && l && _) {
          this._isSliding = !0,
          m && this.pause(),
...
function(e, t) {
  ...
  var e = {
    form: "El formulario",
    select: "El cuadro de selección",
    textarea: "El área de texto",
    checkbox: "La casilla de verificación",
    radio: "El botón de opción",
    text: "El campo de texto",
    password: "La contraseña",
    email: "El correo electrónico",
    url: "La URL",
    number: "El número",
    datetime: "La fecha y hora",
    "datetime-local": "La fecha y hora local",
    date: "La fecha",
    month: "El mes",
    time: "La hora",
    week: "La semana",
...
function(e, t) {
  ...
  function h(e, t, r) {
    ...
    if ((typeof s.type == "undefined" || s.type.toLowerCase() != "checkbox" && s.type.toLowerCase() != "radio") && t == "Checked") i = {
      successful: !1,
    ...
    if (s.tagName.toLowerCase() != "select" && t == "Selected") i = {
      successful: !1,
...
function(e, t) {
  ...
  function v(e) {
    ...
    if (i != "form" && i != "select" && i != "textarea" && i != "input") t = {
      successful: !1,
  ...
  function m(n, r) {
    ...
    if (m && m.groups) if (m.groups instanceof Array) {
      var w = [],
      E = 0;
...
! function(e) {
  ...
  e.fn.formToArray = function(t, r) {
    ...
    if (m = e.fieldValue(d, !0), m && m.constructor == Array) for (r && r.push(d), l = 0, h = m.length; h > l; l++) a.push({
      name: f,
      value: m[l]
    });
    else
...
function() {
  ...
  o.removeEvent = function(t) {
    ...
    if (t instanceof RegExp) for (e in  o) o.hasOwnProperty(e) && t.test(e) && delete o[e];
  ...
  function n(e) {
    ...
    return function(t) {
      if (n(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
        ...
        x = f && h,
        E = i(e.width); ! 1 !== E && (r.width = E + (x ? 0 : g + z));
        var b = i(e.height);
...
function(t, e) {
  ...
  o.makeArray = function(t) {
    ...
    if (t && "number" == typeof t.length) for (var i = 0, n = t.length; n > i; i++) e.push(t[i]);
    else e.push(t);
    return e
  },
...
/////////// ASPIGE ///////////
      ...
      document.addEventListener('DOMContentLoaded', function() {
        var itabs = document.getElementById('itabs');
        var itablinks = itabs.getElementsByTagName('a');
        var currentIndex = 0; // Inicializa el índice
        // Añade evento a cada enlace
        Array.prototype.forEach.call(itablinks, function(link, index) {
          link.addEventListener('click', function() {
            currentIndex = index; // Guarda el índice del enlace actual
            // Eliminar la clase hover después de hacer clic en dispositivos móviles
            if ('ontouchstart' in document.documentElement) {
              link.blur();
            }
          });
        });
        // Añade evento a sigdiv para navegar al siguiente enlace
        var sigdiv = document.getElementById('sigdiv');
        var bitabs = document.getElementById('b-itabs'); //botón del menú
        sigdiv.addEventListener('click', function() {
          bitabs.click(); //ir con el boton del menú.
          if (currentIndex >= 0 && currentIndex < itablinks.length - 1) {
              itablinks[currentIndex + 1].click();
          } else if (currentIndex === itablinks.length - 1) {
              itablinks[0].click(); // Opcional: Volver al primer enlace si estamos en el último
          }
        });
      }),

      document.addEventListener('DOMContentLoaded', function() {
        var contactForm = document.getElementById('modalCta'),
            mensaje = document.getElementById('mensaje');

        contactForm.addEventListener('submit', function(event) {
            if (mensaje.value.trim() === '') { // Verifica si el campo está vacío
                mensaje.value = mensaje.placeholder // Si está vacío, establece el valor del placeholder
            }
        });

        mensaje.addEventListener('keydown', function(event) {
            if (event.key === 'Tab' && this.value.trim() === '') { // Verifica si la tecla presionada es Tab y el campo está vacío
                event.preventDefault() // Prevenir el comportamiento predeterminado de Tab
                this.value = this.placeholder // Establecer el valor del placeholder en el campo
            }
        });
      }),

      // Comportamiento generalizado del placeholder para formularios de contacto
      document.addEventListener("DOMContentLoaded", function () {
      // Selecciona todos los formularios que necesitan el comportamiento
      const formularios = document.querySelectorAll('form[data-form-type="contact-modal"], form[data-form-type="contact"]');

      formularios.forEach((formulario) => {
        // Selecciona todos los campos de texto con placeholder dentro del formulario
        const mensajeInput = formulario.querySelector('textarea[placeholder]');

        if (mensajeInput) {
          // Autocompletar el placeholder cuando se presiona Tab
          mensajeInput.addEventListener("keydown", function (e) {
            if (e.key === "Tab" && !mensajeInput.value.trim()) {
              e.preventDefault(); // Prevenir el comportamiento por defecto de Tab
              mensajeInput.value = mensajeInput.placeholder; // Establecer el placeholder como valor
              mensajeInput.setSelectionRange(mensajeInput.value.length, mensajeInput.value.length); // Mover el cursor al final del texto
            }
          });

          // Enviar el placeholder como mensaje si el campo está vacío
          formulario.addEventListener("submit", function () {
            if (!mensajeInput.value.trim()) {
              mensajeInput.value = mensajeInput.placeholder; // Usar el placeholder como valor
            }
          });
        }
      });
...
/////////// ASPIGE ///////////
      ...
      (a.prototype.goToAnchor = function (t, o) {
        var e, a, customOffset = 0;
        return (
          (a = this.hash),
          (e = n(a)),
          (a === "#servicios") && (customOffset = 50),
          (a === "#itabs") && (customOffset = -20),
          !!t.getOption("anchorNav") &&
            (e.length &&
              (o.preventDefault(),
              n("html, body")
                .stop()
                .animate({ scrollTop: e.offset().top + t.getOption("anchorNavOffset")+ customOffset + 1 }, t.getOption("anchorNavSpeed"), t.getOption("anchorNavEasing"), function () {
      ...
      (a.prototype.activateAnchor = function (t) {
        ...
        // Caso especial: al inicio de la página
        if (u === 0) {
          o = n('[data-type="anchor"]').first(); // Primer anclaje
          i = "#" + o.attr("id");
          e = n('.rd-navbar-nav a[href^="' + i + '"]').parent();
          if (!e.hasClass("active")) {
            e.addClass("active").siblings().removeClass("active");
            if (s.options.callbacks.onAnchorChange) s.options.callbacks.onAnchorChange.call(o[0], s);
          }
          return o;
        }
        if (u + h > r - 50)
...
! function() {
  ...
  var e, a = function(t, s) {
    ...
    function d(e) {
      ...
      if (0 !== a) {
        if (y.params.mousewheelInvert && (a = -a), y.params.freeMode) {
          ...
          if (y.isBeginning && !y.params.loop || y.animating) {
            if (y.params.mousewheelReleaseOnEdges) return !0
          } else y.slidePrev(),
          y.emit("onScroll", y, e);
    ...
    if ("object" == typeof s[w]) for (var x in  c[w]) void 0 === s[w][x] && (s[w][x] = c[w][x]);
    var y = this;
    ...
    y.params.breakpoints && y.setBreakpoint(), y.container = e(t), 0 !== y.container.length)) {
      ...
      y.onTouchMove = function(a) {
        if (a.originalEvent && (a = a.originalEvent), !G || "mousemove" !== a.type) {
          ...
          if (y.touches.currentY < y.touches.startY && y.translate <= y.maxTranslate() || y.touches.currentY > y.touches.startY && y.translate >= y.minTranslate()) return;
        ...
        if (a.originalEvent && (a = a.originalEvent), S && y.emit("onTouchEnd", y, a), S = !1, b) {
          ...
          if (r = y.params.followFinger ? y.rtl ? y.translate : -y.translate : -P, y.params.freeMode) {
            ...
            if (y.params.freeModeMomentum) {
              ...
              if (m > y.minTranslate()) y.params.freeModeMomentumBounce ? (m - y.minTranslate() > g && (m = y.minTranslate() + g), u = y.minTranslate(), c = !0, D = !0) : m = y.minTranslate();
              else
              if (y.params.freeModeSticky) {
                var h, v = 0;
              ...
              if (y.params.freeModeSticky) return void y.slideReset();
        ...
        cube: {
          setTranslate: function() {
            ...
            if (y.wrapper.css({
              ...
              h = 1.5 - (Math.sin(2 * g * Math.PI / 480) / 2 + Math.cos(2 * g * Math.PI / 480) / 2),
      ...
      y.lazy = {
        ...
        loadImageInSlide: function(a, t) {
          if (void 0 !== a && (void 0 === t && (t = !0), 0 !== y.slides.length)) {
            var s = y.slides.eq(a),
            r = s.find("." + y.params.lazyLoadingClass + ":not(." + y.params.lazyStatusLoadedClass + "):not(." + y.params.lazyStatusLoadingClass + ")"); ! s.hasClass(y.params.lazyLoadingClass) || s.hasClass(y.params.lazyStatusLoadedClass) || s.hasClass(y.params.lazyStatusLoadingClass) || (r = r.add(s[0])),
        ...
        load: function() {
          ...
          if (t > 1) for (a = y.activeIndex; a < y.activeIndex + t; a++) y.slides[a] && y.lazy.loadImageInSlide(a);
...
function(a, b) {
  "function" == typeof define && define.amd ? define(["jquery"], function(a) {
    ...
    c.prototype.init = function() {
      ...
      a.$el.on("onDragend.lg.tm touchend.lg.tm onSlideClick.lg.tm", function() { ! a.interval && a.canceledOnTouch && (a.startlAuto(), a.canceledOnTouch = !1)
      })
    },
...
function(a, b) {
  "function" == typeof define && define.amd ? define(["jquery"], function(a) {
    ...
    c.prototype.init = function() {
      ...
      var c = function(a) {
        if (a.find(".lg-object").hasClass("lg-has-poster") && a.find(".lg-object").is(":visible")) if (a.hasClass("lg-has-video")) {
          ...
          if (e) e.contentWindow.postMessage("play", "*");
          else
          if (f) if (b.core.s.videojs) try {
            videojs(f).play()
          } catch(a) {
            console.error("Make sure you have included videojs")
          } else f.play();
      ...
      b.core.$el.on("onBeforeSlide.lg.tm", function(c, d, e) {
        ...
        if (i) i.contentWindow.postMessage("pause", "*");
        else
        if (k) if (b.core.s.videojs) try {
          videojs(k).pause()
        } catch(a) {
          console.error("Make sure you have included videojs")
        } else k.pause();
    ...
    c.prototype.loadVideo = function(b, c, d, e, f) {
      ...
      if (j.dailymotion) i = "?wmode=opaque&autoplay=" + h + "&api=postMessage",
...
var pJS = function(e, a) {
  ...
  i.fn.modes.bubbleParticle = function(e) {
    ...
    if (i.interactivity.events.onclick.enable && isInArray("bubble", i.interactivity.events.onclick.mode)) {
  ...
  i.fn.modes.repulseParticle = function(e) {
    ...
    if (i.interactivity.events.onclick.enable && isInArray("repulse", i.interactivity.events.onclick.mode)) if (i.tmp.repulse_finish || (i.tmp.repulse_count++, i.tmp.repulse_count == i.particles.array.length && (i.tmp.repulse_finish = !0)), i.tmp.repulse_clicking) {
