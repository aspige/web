...
(function () {
	...
	function lazyInit ( element, func ) {
		...
		scrollHandler();
		$window.on( 'scroll', scrollHandler+500 );
	}
	...
	$( function () {
		...
		function attachFormValidator(elements) {
			...
			regula.custom({
				...
				defaultMessage: 'Formato no válido',
				validator: function() {
			...
			var regularConstraintsMessages = [
				{
				  ...
				  newMessage: "Dato obligatorio."
				},
				{
				  type: regula.Constraint.Email,
				  newMessage: "Correo electrónico no válido."
				},
				{
				  type: regula.Constraint.Numeric,
				  newMessage: "Sólo puede escribir números."
				},
				{
		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					...
					'MF001': '¡No se han configurado destinatarios!',
					...
					beforeSubmit: function (arr, $form, options) {
						...
						if (isValidated(inputs, captcha)) {
							...
							if (captcha.length) {
								var captchaToken = captcha.find('.g-recaptcha-response').val(),
									captchaMsg = {
										'CPT001': 'Por favor, configura tu "clave del sitio" y "clave secreta" de reCaptcha',
										'CPT002': 'Algo salió mal con Google reCaptcha'
									};
